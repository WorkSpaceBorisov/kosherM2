...
class AttributeGroups extends Wine
{
    /**
    ...
    public function execute()
    {
        ...
        $attributes = $this->collectionFormAttr->create();
        if ($attributes->count() > 0) {
            ...
            foreach ($attributes as $attribute) {
                $products[] = array($attribute->getAttributeGroupName(), json_encode($attribute->getData()));
            }
